...
def _nettoyer_desc(desc_raw: str) -> str:
    ...
    - Filtre les lignes qui sont des specs techniques ou notes client
    ...
    # Filtrer les lignes à exclure du titre produit
    specs_prefixes = (
        "rated power", "size:", "output", "input", "voltage", "capacity",
        "intelligent", "ac220v", "dc12v", "usb ", "type-c", "use:",
        ">=", "pcs", "set", "sample",
        # Fragments persistants CHREDSUN
        "can continuous", "can be used", "the client", "people can",
        "it adapts", "no matter", "equipped with", "compared to",
        "our water", "self-generating", "for adding",
    )
